...
public class Lista {
   ...
   public Lista listaordenada(Lista lista){
  ...
  public void calcularpromedio(){
      ...
      JOptionPane.showMessageDialog(null,"EL número("+prom+") corresponde a la media de los datos");
 ...
 public void calculardesviacion(){
     JOptionPane.showMessageDialog(null,"DESVIACIÓN ESTÁNDAR :  "+Math.sqrt(calcularvarianza()));
 ...
 public  void calcularmoda(){
   ...
   JOptionPane.showMessageDialog(null, "La moda de los datos es "+moda);
