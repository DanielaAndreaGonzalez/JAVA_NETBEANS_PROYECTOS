 ...
 * @author DAGonzalezH
 */
public class BuscarVotante extends javax.swing.JDialog {

    /**
     * Creates new form BuscarVotante
     */
    public BuscarVotante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 130, 60));
        ...
        jLabel15.setText("Buscar Votante ");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 10, 160, 50));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarVotante dialog = new BuscarVotante(new javax.swing.JFrame(), true);
